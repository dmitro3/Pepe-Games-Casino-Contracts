...
interface CoinTossV5Interface extends ethers.utils.Interface {
  functions: {
    ...
    "wager(bool,address,uint256)": FunctionFragment;
  };
  ...
  events: {
    ...
    "PlaceBet(uint256,address,address,uint256,bool)": EventFragment;
    "Roll(uint256,address,address,uint256,bool,bool)": EventFragment;
...
export class CoinTossV5 extends Contract {
